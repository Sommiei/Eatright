...
export const Footer = () => {
  return (
    <>
      <footer className="footer p-10 bg-white flex md:flex-wrap lg:justify-around items-start pb-10 ">
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover"href="ReturnPolicy">Return Policy</a>
        </nav>
        <div>
          <img className="mx-2" src="/Eatright-logo.png" alt="logo" />
        </div>
      </footer>

      <footer className="footer items-center p-4 bg-white flex justify-around">
